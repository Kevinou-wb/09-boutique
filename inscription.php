...
<form method="post" class="col-md-6 mx-auto">
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control <?php if(isset($errorPseudo)) echo $border; ?>" id="pseudo" name="pseudo" placeholder="ex : Kevin123456" value="<?php if(isset($_POST['pseudo'])) echo $_POST['pseudo']; ?>">
